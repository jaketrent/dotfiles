...
you should place your code here."
    ...
    ;; when tree open, open to current file from https://www.emacswiki.org/emacs/NeoTree#toc4
    ...
    (global-set-key (kbd "<S-tab>") 'un-indent)
    (defun un-indent ()
      "remove indentation from beginning of current line"
      (interactive)
      (save-excursion
        (save-match-data
          (beginning-of-line)
